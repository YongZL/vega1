...
import Target from '@/components/print/procurementUseTwo';
		...
		<div className={styles.instockConnection}>
			...
			<Card bordered={false}>
				...
				<TableBox
					...
					toolBarRender={() => [
						permissions.includes('procurementUseTwoPrint') && (
							<>
								{searchParams.timeFrom && searchParams.timeTo ? (
									<PrintTarget
										url={api.procurementUse.list}
										params={{ ...searchParams, procurementUseType: 'two' }}
						...
						permissions.includes('procurementUseTwoExport') && (
							<>
								{searchParams.timeFrom && searchParams.timeTo ? (
									<ExportFile
										data={{
											filters: { ...searchParams, procurementUseType: 'two' },
