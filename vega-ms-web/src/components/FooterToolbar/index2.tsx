...
export default class FooterToolbar2 extends Component<FooterToolbarProps> {
	getWidth = ({
		collapsed,
		isMobile,
		siderWidth,
		...
		return isMobile ? undefined : `calc(100% - ${collapsed ? 64 : siderWidth || 200}px)`;
	};
	...
	render() {
		...
		return (
			<RouteContext.Consumer>
				{(value) => (
					<div
						className={classNames(className, styles.toolbar2)}
